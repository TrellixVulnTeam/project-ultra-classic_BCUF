...
; this installed.
!define FallbackKey \
  "Software\GamesandOSStudio\MaintenanceService\3932ecacee736d366d6436db0f55bce4"

!define CompanyName "GamesandOSStudio"
...
InstallDirRegKey HKLM "Software\GamesandOSStudio\MaintenanceService" ""
...
!define MaintUninstallKey \
 "Software\Microsoft\Windows\CurrentVersion\Uninstall\GamesandOSStudioMaintenanceService"
...
Section "MaintenanceService"
  ...
  WriteRegDWORD HKLM "Software\GamesandOSStudio\MaintenanceService" "Installed" 1
  DeleteRegValue HKLM "Software\GamesandOSStudio\MaintenanceService" "FFPrefetchDisabled"
...
Section "Uninstall"
  ...
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-1.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-2.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-3.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-4.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-5.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-6.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-7.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-8.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-9.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-10.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-install.log"
  Call un.RenameDelete
  Push "$APPDATA\GamesandOSStudio\logs\maintenanceservice-uninstall.log"
  Call un.RenameDelete
  RMDir /REBOOTOK "$APPDATA\GamesandOSStudio\logs"
  RMDir /REBOOTOK "$APPDATA\GamesandOSStudio"
  ...
  ${If} ${RunningX64}
    SetRegView 64
  ${EndIf}
  DeleteRegValue HKLM "Software\GamesandOSStudio\MaintenanceService" "Installed"
  DeleteRegValue HKLM "Software\GamesandOSStudio\MaintenanceService" "FFPrefetchDisabled"
