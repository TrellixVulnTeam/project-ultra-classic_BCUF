...
//   are mapped like so:
//
//   HKCU\SOFTWARE\Classes\.<ext>\      (default)         REG_SZ     PJUCHTML
//
//   as aliases to the class:
//
//   HKCU\SOFTWARE\Classes\PJUCHTML\
...
//
//   HKCU\SOFTWARE\Classes\PJUCURL\  (default)         REG_SZ     <appname> URL
...
static SETTING gSettings[] = {
  ...
  { MAKE_KEY_NAME1("PJUCHTML", SOC), VAL_OPEN, OLD_VAL_OPEN },

  // Protocol Handler Class - for Vista and above
  { MAKE_KEY_NAME1("PJUCURL", SOC), VAL_OPEN, OLD_VAL_OPEN },
...
static SETTING gDDESettings[] = {
  // File Handler Class
  { MAKE_KEY_NAME1("Software\\Classes\\PJUCHTML", SOD) },

  // Protocol Handler Class - for Vista and above
  { MAKE_KEY_NAME1("Software\\Classes\\PJUCURL", SOD) },
             ...
             LPCWSTR aClassName)
{
  ...
  LPCWSTR progID = isProtocol ? L"PJUCURL" : L"PJUCHTML";
 ...
 * This only checks for PJUCURL and if aCheckAllTypes is set, then
 * it also checks for PJUCHTML.  Note that those ProgIDs are shared
