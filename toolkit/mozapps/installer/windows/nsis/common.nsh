 ...
 *
 * @param   _KEY
 *          The registry subkey (typically this will be Software\GamesandOSStudio).
 * @return  _RESULT
 ...
 *
 * @param   _KEY
 *          The registry subkey (typically this will be Software\GamesandOSStudio\App Name).
 * @return  _RESULT
...
!ifndef NO_INSTDIR_FROM_REG
      ...
      ${GetSingleInstallPath} "Software\GamesandOSStudio\${BrandFullNameInternal}" $R9
 ...
 *          be stored. ex: "Software\GamesandOSStudio\ProjectUltraClassic\TaskBarIDs"
