         ...
         LPWSTR  lpszCmdLine, int  nCmdShow)
{
  ...
  HKEY hkeyCU, hkeyLM;
  RegOpenKeyExW(HKEY_CURRENT_USER, L"Software\\gamesandosstudio.com\\windbgdlg", 0, KEY_READ, &hkeyCU);
  RegOpenKeyExW(HKEY_LOCAL_MACHINE, L"Software\\gamesandosstudio.com\\windbgdlg", 0, KEY_READ, &hkeyLM);
  int argc =0;
